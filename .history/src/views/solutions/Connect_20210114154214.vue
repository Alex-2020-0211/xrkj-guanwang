...
export default {
  ...
  methods: {
    ...
    async getCode(){
      ...
      this.$ajax.get('/api/v1/sys/official/website/customer/joinsendcode',{
    ...
    async postCode(code){
      ...
      this.$ajax.post('/api/v1/sys/official/website/customer/joinvailcode', JSON.stringify(params))
          .then(res =>{
            console.log(res);
          })
          .catch(err => {
    ...
    async joinUs(){
      ...
      this.$ajax.post('/api/v1/sys/official/website/customer/joinvailcode',{
        customerPhone: customerPhone
      },res=>{
        console.log(res);
      })
