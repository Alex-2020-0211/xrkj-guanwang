  ...
  <div class="connect">
    ...
    <div class="content" v-show="isCode">
      ...
      <div class="right">
        ...
        <el-button class="liji" type="primary" @click="joinUs()">立即了解</el-button>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async getCode(){
      ...
      let res = await Ajax.Get('/api/v1/sys/official/website/customer/joinsendcode', {
        customerPhone: customerPhone
      })
      console.log(res);
      this.get('/api/v1/sys/official/website/customer/joinsendcode'，{
        customerPhone: customerPhone
      }).then(res=>{
        console.log(res);
      })
      // this.$fetch('/api/v1/sys/official/website/customer/joinsendcode', {
      //   customerPhone: customerPhone
      // })
      //     .then(res =>{
      //       console.log(res);
    ...
    async joinUs(){
      ...
      http.postJson('/api/v1/sys/official/website/customer/joincompany', JSON.stringify(params))
          .then(res =>{
            console.log(res)
          })
          .catch(err => {
