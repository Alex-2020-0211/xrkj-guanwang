...
export default {
  ...
  methods: {
    ...
    async getCode(customerPhone){
      ...
      http.get('/official/website/customer/joinsendcode',customerPhone)
          .then(res =>{
            console.log(res)
          })
    ...
    async postCode(code){
      ...
      http.postJson('/official/website/customer/joinvailcode', JSON.stringify(params))
    }
  },
};
</script>
