  ...
  <div class="connect">
    ...
    <div class="content2" v-show="rightCode">
      <div class="right2">
        ...
        <button v-show="isHome" class="fanhui" @click="toHome()"><span>{{num}}</span>s后自动返回首页~</button>
        <button v-show="isHome" class="fanhui-hover" @click="toHome2()"><span>{{num}}</span>s后自动返回首页~</button>
        <p>客服火速赶往中...</p>
      </div>
    </div>
